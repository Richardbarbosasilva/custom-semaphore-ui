export default {
  ...
  overview_subtitle: 'Track delivery health, workload and recent runs across the last {days} days.',
  overview_live: 'Live',
  overview_last_run: 'Last run',
  overview_last_updated: 'Updated {time}',
  overview_total_runs: 'Total runs',
  overview_success_rate: 'Success rate',
  overview_failed_runs: 'Failed runs',
  overview_daily_pace: 'Daily pace',
  overview_vs_previous_period: 'vs previous period',
  overview_execution_trend: 'Execution trend',
  overview_execution_trend_subtitle: 'Daily volume by status and active runs for the selected window.',
  overview_status_breakdown: 'Status breakdown',
  overview_status_breakdown_subtitle: 'Share of successful, failed, active and stopped runs.',
  overview_top_templates: 'Most used templates',
  overview_top_templates_subtitle: 'Based on the selected time window.',
  overview_top_users: 'Most active users',
  overview_top_users_subtitle: 'Execution volume by user in the selected time window.',
  overview_no_users: 'No user activity found for the selected period.',
  overview_success_rate_compact: '{rate}% success rate',
  overview_recent_runs: 'Recent runs',
  overview_recent_runs_subtitle: 'Latest executions with live status updates.',
  overview_runs_count: '{count} runs',
  overview_no_templates: 'No recent template activity.',
  overview_no_change: 'No change',
  overview_new_data: 'New',
  overview_active_runs: 'Active runs',
  sidebar_brand_caption: 'Operations center',
  sidebar_workspace: 'Workspace',
  sidebar_resources: 'Resources',
  sidebar_access: 'Access',
  activity_feed_subtitle: 'Recent project audit trail focused on operational events and changes.',
  stats_visual_subtitle: 'Visual readout of execution volume by period and by user.',
  auth_eyebrow: 'Operational platform',
  auth_headline: 'Critical automation with operational visibility.',
  auth_subtitle: 'Monitor runs, history and infrastructure through a UI redesigned for day-to-day operations.',
