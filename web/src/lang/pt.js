export default {
  ...
  overview_title: 'Visão operacional',
  overview_subtitle: 'Acompanhe a saúde das execuções, o volume e a atividade recente nos últimos {days} dias.',
  overview_live: 'Ao vivo',
  overview_last_run: 'Última execução',
  overview_last_updated: 'Atualizado {time}',
  overview_total_runs: 'Execuções totais',
  overview_success_rate: 'Taxa de sucesso',
  overview_failed_runs: 'Falhas',
  overview_daily_pace: 'Ritmo diário',
  overview_vs_previous_period: 'vs período anterior',
  overview_execution_trend: 'Tendência de execução',
  overview_execution_trend_subtitle: 'Volume diário por status e execuções ativas na janela selecionada.',
  overview_status_breakdown: 'Distribuição por status',
  overview_status_breakdown_subtitle: 'Participação de sucessos, falhas, execuções ativas e interrompidas.',
  overview_top_templates: 'Modelos mais usados',
  overview_top_templates_subtitle: 'Baseado na janela de tempo selecionada.',
  overview_top_users: 'Usuários mais ativos',
  overview_top_users_subtitle: 'Volume de execuções por usuário na janela selecionada.',
  overview_no_users: 'Nenhuma atividade de usuário encontrada no período selecionado.',
  overview_success_rate_compact: '{rate}% de sucesso',
  overview_recent_runs: 'Execuções recentes',
  overview_recent_runs_subtitle: 'Últimas execuções com atualização em tempo real.',
  overview_runs_count: '{count} execuções',
  overview_no_templates: 'Sem atividade recente de modelos.',
  overview_no_change: 'Sem mudança',
  overview_new_data: 'Novo',
  overview_active_runs: 'Em execução',
  sidebar_brand_caption: 'Centro de operações',
  sidebar_workspace: 'Workspace',
  sidebar_resources: 'Recursos',
  sidebar_access: 'Acesso',
  activity_feed_subtitle: 'Auditoria recente do projeto com foco em eventos e alterações operacionais.',
  stats_visual_subtitle: 'Leitura visual do volume de execução por período e por usuário.',
  auth_eyebrow: 'Plataforma operacional',
  auth_headline: 'Automação crítica com visibilidade operacional.',
  auth_subtitle: 'Monitore execuções, histórico e infraestrutura em uma interface redesenhada para operação diária.',
