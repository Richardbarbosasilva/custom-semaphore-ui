          ...
          <v-card class="auth__card" flat>
            <v-card-text class="pa-0">
              ...
              >
                ...
                <div class="auth__mode-chip-wrap" v-if="screen == null && ldapEnabled">
                  <v-chip small label outlined color="primary">
                    LDAP / Active Directory disponível neste ambiente
                  </v-chip>
                </div>
  ...
  methods: {
    ...
    async loadLoginData() {
      await axios({
        ...
        this.ldapEnabled = resp.data.ldap_enabled;
      });
    },
